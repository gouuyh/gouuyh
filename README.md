## Welcome! Here is <ruby>含章<rt>gouuyh</rt></ruby> 👋
...
- Mainly use **Python**.
- Learning **Rust**.
- Planing to build my blog with **Hugo**.
...
- **Arch Linux** is the one of the dual boot system on my laptop.
- Usually choose **Debian** as the server system.
